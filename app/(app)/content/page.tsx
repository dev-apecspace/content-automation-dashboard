...
export default function ContentPage() {
  ...
  const handleApproveIdea = async (item: ContentItem) => {
    ...
    try {
      const updated = await approveIdea(item.id, "user_1", item.idea, item.projectName, item.contentType, item.imageLink )
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">Quản lý bài viết cho các nền tảng mạng xã hội</p>
        </div>
